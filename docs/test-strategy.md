...
13. Run the fixed RAG evaluation, require at least 90% retrieval recall within the top three,
    ...
    in both questions and runbook ingestion without rejecting the 11 security-related legitimate
    questions, and exercise a cited answer through Nginx.
